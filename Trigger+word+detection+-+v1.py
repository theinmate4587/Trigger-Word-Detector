...
print("activate[3] len: " + str(len(activates[1])))     # Different "activate" clips can have different lengths 
...
def is_overlapping(segment_time, previous_segments):
    ...
    for previous_start, previous_end in previous_segments:
        if   previous_end >=segment_start and segment_end >= previous_start:
            overlap = True
    ### END CODE HERE ###
